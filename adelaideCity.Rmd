---
title: "Interesting facts about Adelaide city"
author: "Varun Khanna"
date: "29 July 2018"
output:
  github_document
...
#### __Acknowledgement__:  All the data is derived from [Data.SA](https://data.sa.gov.au/data/dataset/adelaide-city-living-market-research)
...
#1. What type of <img src="images/social/people.png" alt="drawing" width="40px"/> live in Adelaide?
```{r people}
...
## Insights: 
####  1. __Cosmopolitians__ are less likely to live in North whereas __Homebodies__ and __Suburbanities__ prefer to live in Northern suburbs of Adelaide.
####  2. __Diffidents__ are distribuited evenly throughout the city.
####  3. __Urbanities__ prefer to live in South while __Traditionalists__ prefer West suburbs.  

---

#2. <img src="images/social/city.png" alt="drawing" width="40px"/> worker status
...
## Insights: 
####  1. There is a __sharp contrast between residents of East and North__. Maximum number of people living in the East travel to city for work while most people in the North travel elsewhere and only a small portion travel to city for work.
####  2. About a quater % of people living in the West do not travel for work.

---

#3. <img src="images/social/gender.png" alt="drawing" width="40px"/> location wise
```{r gender}
...
## Insights: 
####  1. Seems like __perfect Gender balance__ in all the suburbs except North where there are more females than males.

---

#4. <img src="images/social/gender.png" alt="drawing" width="40px"/> segment wise
```{r gender_seg}
...
## Insights: 
####  1. Male dominated __Diffidents, Suburbanities and Urbanities__.
####  2. Female dominated __Homebodies and Traditionalists__.

---


#5. <img src="images/social/age.jpg" alt="drawing" width="40px"/> distribution of Adelaide residents 
```{r}
...
## Insights: 
####  1. Most __dominant agegroup__ in Adelaide __50-to-59__. 
####  2. Most number of people __above 75 live in West__ as compared to other areas.
####  3. __North and South__ also have quite large percentage of people from __25-to-39__ agegroup.
...
#7. Main method of <img src="images/social/transport.png" alt="drawing" width="40px"/>
```{r message=FALSE, fig.keep='all'}
...
## Insights: 
####  1. __Car and Public transport__ are clearly most favourite mode of transport of the residents of Adelaide. 
...
```{r message=FALSE, fig.keep='all', echo = FALSE}
...
#time_loc$minutes <- as.factor(time_loc$minutes)
#ordered(time_loc$minutes, levels = #c("<20","20-to-40","40-to-60","60-to-80","80-to-100",">100"))
...
#9. <img src="images/social/home.png" alt="drawing" width="40px"/> ownership.
```{r message=FALSE, fig.keep='all'}
...
#10. Estimated value of the current <img src="images/social/home.png" alt="drawing" width="40px"/>.
```{r message=FALSE, fig.keep='all'}
...
#11. How likely would you be to purchase a new <img src="images/social/home.png" alt="drawing" width="40px"/> or land in next five years?
```{r message=FALSE, fig.keep='all'}
...
#12.  In which of the following areas do you plan to buy this <img src="images/social/home.png" alt="drawing" width="40px"/>?
```{r message=FALSE, fig.keep='all'}
...
#13. What is your <img src="images/social/budget.png" alt="drawing" width="40px"/> if you were to consider purchasing a new home or land?
...
## Insights: 
#### 1. A __good percentage__ of people in __south have over a million dollor__ <img src="images/social/budget.png" alt="drawing" width="20px"/> <img src="images/social/happy.jpg" alt="drawing" width="20px"/>
...
## Insights: 
#### 1. __Most residents__ view Adelaide as a __"liveable, multicultural, cosmopolitan, vibrant, green and beautiful city"__ which is full of arts and culture.
#### 2. However, __few people__ think Adelaide is a __"smart, progressive  and in innovative city"__.
...
## Insights: 
#### 1. __Above 60%__ of the residents in the __West and North__ agree that Australians are not doing enough to combat climate change.
#### 2. Residents in the __East are most skeptical__ of the claim that "Australians are not doing enough..."
...
## Insights: 
#### 1. Residents in the __West and South of Adelaide are more likely to pay higher__ <img src="images/social/electric_bill.png" alt="drawing" width="30px"/> if electricity was generated from renewable resources.
#### 2. Residents in the __North are more reluctant__ to pay higher <img src="images/social/electric_bill.png" alt="drawing" width="30px"/>. Although, more than 60% of the residents in the North agree that Australians are not doing enough to combat climate change.
...
## Insights: 
#### 1. Residents in the North are much less <img src="images/social/travel.png" alt="drawing" width="30px"/> than their peers.
...
## Insights: 
#### 1. <img src="images/social/facebook.png" alt="drawing" width="20px"/> is the clear <img src="images/social/cup.png" alt="drawing" width="20px"/> followed by <img src="images/social/youtube.png" alt="drawing" width="30px"/>, <img src="images/social/instagram.png" alt="drawing" width="20px"/>, <img src="images/social/snapchat.png" alt="drawing" width="20px"/>, <img src="images/social/twitter.png" alt="drawing" width="20px"/> and <img src="images/social/linkedin.png" alt="drawing" width="20px"/>.
#### 2. People in the __North are more active__ on social media sites than others. 
#### 3. There are __substantial number__ of people who __do not visit social media sites__.